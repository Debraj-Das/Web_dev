...
app.put("/jokes/:id", (req, res) => {
	...
	const jokeIndex = jokes.findIndex((joke) => joke.id === newId);
	if(jokeIndex === -1)
	{
		res.state(404).send("jokes id not find");
	}
...
app.patch("/jokes/:id", (req, res) => {
	...
	if(jokeIndex === -1)
	{
		res.status(404).send("jokes id not find");
	}
...
app.delete("/all", (req, res) => {
	console.log(req);
	if(masterKey !== req.body.key)
	{
		res.status(404).send("non autherized operation");
	}
